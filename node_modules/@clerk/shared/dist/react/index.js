...
var useAttachEvent = (element, event, cb) => {
  const cbDefined = !!cb;
  const cbRef = (0, import_react7.useRef)(cb);
  (0, import_react7.useEffect)(() => {
    cbRef.current = cb;
  }, [cb]);
  (0, import_react7.useEffect)(() => {
...
// src/react/stripe-react/index.tsx
var ElementsContext = import_react8.default.createContext(null);
...
var Elements = ({
  ...
  const parsed = import_react8.default.useMemo(() => parseStripeProp(rawStripeProp), [rawStripeProp]);
  const [ctx, setContext] = import_react8.default.useState(() => ({
  ...
  return /* @__PURE__ */ import_react8.default.createElement(ElementsContext.Provider, { value: ctx }, children);
};
var useElementsContextWithUseCase = (useCaseMessage) => {
  const ctx = import_react8.default.useContext(ElementsContext);
...
var useElementsOrCheckoutSdkContextWithUseCase = (useCaseString) => {
  const elementsContext = import_react8.default.useContext(ElementsContext);
...
var createElementComponent = (type, isServer2) => {
  ...
  const ClientElement = ({
    ...
    const [element, setElement] = import_react8.default.useState(null);
    const elementRef = import_react8.default.useRef(null);
    const domNode = import_react8.default.useRef(null);
    const [isReady, setReady] = (0, import_react8.useState)(false);
    ...
    return /* @__PURE__ */ import_react8.default.createElement(import_react8.default.Fragment, null, !isReady && fallback, /* @__PURE__ */ import_react8.default.createElement(
      "div",
      {
        id,
        className,
...
var ValidateStripeUtils = ({ children }) => {
  ...
  return /* @__PURE__ */ import_react10.default.createElement(StripeUtilsContext.Provider, { value: { value: { stripe, elements } } }, children);
};
var DummyStripeUtils = ({ children }) => {
  return /* @__PURE__ */ import_react10.default.createElement(StripeUtilsContext.Provider, { value: { value: {} } }, children);
};
var PropsProvider = ({ children, ...props }) => {
  const utils = usePaymentSourceUtils(props.for);
  const [isPaymentElementReady, setIsPaymentElementReady] = (0, import_react9.useState)(false);
  return /* @__PURE__ */ import_react10.default.createElement(
...
var PaymentElementProvider = ({ children, ...props }) => {
  return /* @__PURE__ */ import_react10.default.createElement(StripeLibsProvider, null, /* @__PURE__ */ import_react10.default.createElement(PropsProvider, { ...props }, /* @__PURE__ */ import_react10.default.createElement(PaymentElementInternalRoot, null, children)));
};
var PaymentElementInternalRoot = (props) => {
  ...
  if (stripe && externalClientSecret) {
    return /* @__PURE__ */ import_react10.default.createElement(
      ...
      /* @__PURE__ */ import_react10.default.createElement(ValidateStripeUtils, null, props.children)
    );
  }
  return /* @__PURE__ */ import_react10.default.createElement(DummyStripeUtils, null, props.children);
};
var PaymentElement2 = ({ fallback }) => {
  ...
  const environment = useInternalEnvironment();
  const applePay = (0, import_react9.useMemo)(() => {
    if (!checkout) {
      return void 0;
    }
    return {
  ...
  const onReady = (0, import_react9.useCallback)(() => {
    setIsPaymentElementReady(true);
  }, [setIsPaymentElementReady]);
  if (!stripe || !externalClientSecret) {
    return /* @__PURE__ */ import_react10.default.createElement(import_react10.default.Fragment, null, fallback);
  }
  return /* @__PURE__ */ import_react10.default.createElement(
    PaymentElement,
    {
...
var usePaymentElement = () => {
  ...
  const reset = (0, import_react9.useCallback)(async () => {
    if (!stripe || !elements) {
      return throwLibsMissingError();
    }
